...
type AuthServiceClient interface {
	...
	LoginStaff(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
...
func (c *authServiceClient) LoginStaff(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
...
type AuthServiceServer interface {
	...
	LoginStaff(context.Context, *LoginRequest) (*LoginResponse, error)
...
func (UnimplementedAuthServiceServer) LoginStaff(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _AuthService_LoginStaff_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LoginStaff(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
